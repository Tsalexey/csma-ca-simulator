...
def main():
    ...
    for i in range(1, input.nodes_number + 1):
        ...
        one_minus_tau_data_divided_by_D_total = 0
        ...
        for j in range(0, repeats):
            ...
            one_minus_tau_data_divided_by_D_total += simulation.one_minus_tau_data_divided_by_D_total
            nodes_count_that_transmitted_data += simulation.nodes_count_that_transmitted_data

            number_of_generated_calls += len(simulation.gateway.successful_processed_rts_messages) + len(
                simulation.gateway.unsuccessful_processed_rts_messages)
        ...
        one_minus_tau_data_divided_by_D_total = one_minus_tau_data_divided_by_D_total / repeats
        ...
        statistics[nodes] = [nodes,
                             ...
                             one_minus_tau_data_divided_by_D_total,
